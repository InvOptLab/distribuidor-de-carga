...
export interface AffectedNode {
  ...
  newDegree: number;
  status: "ORPHAN" | "CRITICAL" | "SAFE" | "FAILED"; // ORPHAN = 0 opções, CRITICAL = 1 opção, FAILED = sobrecarregado
}
...
export interface CapacityCascadeResult {
  sourceTeacherId: string;
  initialCascadeSize: number;
