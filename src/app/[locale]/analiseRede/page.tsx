    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      {!hasData ? (
        ...
        <>
          ...
          {tabIndex === 0 && <NetworkDashboard report={report} centrality={centrality} />}
          ...
          {tabIndex === 2 && (
            <CapacitySimulator graph={graph} simulateCapacityCascade={simulateCapacityCascade} />
          )}
